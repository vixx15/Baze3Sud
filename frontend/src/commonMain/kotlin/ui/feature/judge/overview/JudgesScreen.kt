...
import ui.feature.judge.JudgesViewModel
import ui.feature.judge.details.CreateJudgeComponent
            ...
            when (viewState.contentMode) {
                ContentMode.EDIT -> {
                    CreateJudgeComponent(
                        ...
                        judgeDetailsDTO = viewState.newDetails ?: JudgeDetailsDTO(),
                        updateJudge = vm::update,
                        confirm = vm::upsert,
                        courtOptions = viewState.courtOptions ?: listOf()
                    )
                }
