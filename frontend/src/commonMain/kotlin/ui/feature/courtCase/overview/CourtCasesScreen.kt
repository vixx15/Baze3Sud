    ...
    Column(modifier = Modifier.fillMaxWidth().padding(12.dp)) {
        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            ...
            when (viewState.contentMode) {
                ContentMode.EDIT -> {
                    CreateCourtCaseComponent(
                        mode = viewState.contentMode,
                        confirm = vm::upsert,
                        courtOptions = viewState.courtOptions,
                        updateCourtCase = vm::update,
                        courtCaseDetailsDTO = viewState.newDetails ?: CourtCaseDetailsDTO(),
                        judgeOptions = viewState.judgesOptions,
                        diputeTypeOptions = viewState.typesOptions,
                    )
                }
